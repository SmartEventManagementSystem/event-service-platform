...
func (f *fakePostManager) GetPost(ctx context.Context, id uuid.UUID) (*response.UserPostResponse, error) {
	return &response.UserPostResponse{ID: id, Title: "t", Content: "c"}, nil
}
...
func (f *fakePostManager) UpdatePost(ctx context.Context, id uuid.UUID, req *request.UpdatePostRequest) (*response.UserPostResponse, error) {
	return &response.UserPostResponse{ID: id, Title: "t"}, nil
}
